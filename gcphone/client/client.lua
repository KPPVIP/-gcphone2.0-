...
--====================================================================================
--  Comprueba si el jugador tiene teléfono.
-- Devolución de llamada verdadera o falsa
--====================================================================================
function hasPhone (cb)
  cb(true)
end
--====================================================================================
--  ¿Qué pasa si los jugadores quieren abrir su teléfono que no tienen?
--====================================================================================
function ShowNoPhoneWarning ()
end

--[[
  Abrir el teléfono vinculado a un elemento
   Una solución ESC basada en la solución dada por HalCroves
...
--====================================================================================
--  Activar o desactivar una aplicación (appName => config.json)
--====================================================================================
...
--[[
  Muestra información cuando el reproductor está cerca de un punto fijo
--]]
...
-- Agregar seguridad para el evento (leuit#0100)
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  while takePhoto do
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      exports['screenshot-basic']:requestScreenshotUpload("https://discordapp.com/api/webhooks/770748759461068870/lJLlrMPu_HjJTliRBDubf1ei1H4IEl847jpyc-CKe9fU7tv2GrvrDK7NEV8fXiGiCU-t", data.field, function(data)
